...
--Define tamanho dos grupos (áreas) do tabuleiro/ redundante?
...
getCelulaDiagDirBaixo t i j | isInRange t i j && i < tamanhoTabuleiro t && j < tamanhoTabuleiro t = (i+1, j+1)
                            | otherwise = (-1,-1)
-- utiliza getters acima para conseguir todas as células adjacentes
...
-- retorna tupla com id de grupo e valor
